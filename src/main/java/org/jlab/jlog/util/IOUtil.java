...
public final class IOUtil {
  ...
  /**
   * Deletes a file without generating any checked Exceptions. If unable to delete then a WARNING
   * will be logged.
   *
   * @param file The file
   */
  ...
  /**
   * Converts a comma-separated-values String to an array of String values. Whitespace on either
   * side of commas are trimmed off.
   *
