...
public final class XMLUtil {
   ...
   */
  public static Element appendElementWithText(
      Document doc, Element parent, String tagName, String text) {
  ...
  /**
   * Creates a new element with child text for a comma separated list of values and appends them to
   ...
   */
  public static void appendCommaDelimitedElementsWithText(
      Document doc, Element parent, String tagName, String list) {
  ...
  /**
   * Creates a new element with child and grandchild with text from a comma separated list of values
   * and appends them to the specified parent.
   *
   * @param doc The Document.
   * @param parent The parent.
  ...
  public static void appendCommaDelimitedElementsWithGrandchildAndText(
      Document doc, Element parent, String childTagName, String grandchildTagName, String list) {
    String[] tokens = IOUtil.csvToArray(list);
  ...
  /**
   * Returns the first occurrence of a child element with the specified tag name. Note: only
   * immediate children are candidates (not all descendents).
   *
   ...
   * @throws TransformerConfigurationException If there is a configuration issue
