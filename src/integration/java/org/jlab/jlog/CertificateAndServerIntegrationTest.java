...
public class CertificateAndServerIntegrationTest {
  ...
  @Test
  public void testGetAuthorFromXMLWithCertificate()
      throws LogException, CertificateException, IOException, InvalidNameException {
    ...
    String expected =
        SecurityUtil.getCommonNameFromCertificate(
            SecurityUtil.fetchCertificateFromPEM(IOUtil.fileToBytes(pemFile)));
  ...
  public void testLargeBodySubmit() throws Exception {
    ...
    // Of that, a "body" portion over ~8MB will generally result in server returning HTTP 500 due to
